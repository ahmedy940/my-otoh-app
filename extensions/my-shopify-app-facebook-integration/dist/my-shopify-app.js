(() => {
  ...
  // extensions/my-shopify-app-facebook-integration/src/ActionExtension.jsx
    ...
    (0, import_react12.useEffect)(() => {
      window.fbAsyncInit = function() {
        FB.init({
          ...
          xfbml: true,
          version: "v11.0"
          // Replace with the Facebook API version you want to use
        });
          ...
          if (response.authResponse) {
            ...
            FB.api("/me", { fields: "id,name,email" }, function(response2) {
              ...
              fetch("/api/store-facebook-token", {
                ...
                body: JSON.stringify({ accessToken: response2.authResponse.accessToken })
              }).then((res) => res.json()).then((data2) => {
                console.log("Token stored:", data2);
              }).catch((error) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      AdminAction2,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Button2, { onPress: handleFBLogin, children: "Login with Facebook" })
        ] })
      }
    );
  }
})();
//# sourceMappingURL=my-shopify-app.js.map
